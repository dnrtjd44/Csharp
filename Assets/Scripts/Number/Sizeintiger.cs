...
public class Sizeintiger : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ushort iUInt16 = 65535; //16비트 부호가 있는 정수형 번수 선언 및 초기화
        uint iUInt32 = 4294967295; //32비트 부호가 있는 정수형 번수 선언 및 초기화
        ulong iUInt64 = 18446744073709551615; //64비트 부호가 있는 정수형 번수 선언 및 초기화
